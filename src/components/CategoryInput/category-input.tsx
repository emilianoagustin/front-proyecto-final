    ...
    <div className="space-y-2">
      ...
      <div
        className={`flex flex-wrap gap-2 p-2 border rounded-md min-h-10 ${
          invalid && "border-2 focus-visible:ring-1 ring-red-700"
        }`}
      >
        ...
        <Input
          ...
          className="flex-1 border-0 focus-visible:ring-0 min-w-[120px] shadow-none"
        />
      </div>
      {error && (
        <FieldError className="text-sm text-destructive" errors={error} />
      )}
